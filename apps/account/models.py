...
class CustomUserManager(BaseUserManager):
    def _create(self, email, password, name=None, last_name=None, **extra_fields):
        if not email:
    ...
    def create_user(self, email, password, name=None, last_name=None, **extra_fields):
        extra_fields.setdefault('is_active', False)
        extra_fields.setdefault('is_staff', False)
        return self._create(email, password, name=None, last_name=None, **extra_fields)

    def create_superuser(self, email, password, name=None, last_name=None, **extra_fields):
